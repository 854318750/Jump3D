...
declare namespace wx {
   ...
   */
  export function downloadFile(object: _qqDownLoadFile): void;
   ...
   */
  export function getStorage(object: any): void;
   ...
   */
  export function setStorage(object: any): void;

  /**
   * 将 data 存储在本地缓存中指定的 key 中，会覆盖掉原来该 key 对应的内容，这是一个同步接口。
   */
  export function setStorageSync(key: string, data): void;
  ...
  */
  ...
  export function aldOnShareAppMessage(obj: any);

  export function shareAppMessage(obj: any);  
  export function aldShareAppMessage(obj: any);  
  ...
  export function onShow(obj: any);
  ...
  module aldStage {
    /**关卡开始 */
    export function onStart(obj: any);
    /**关卡完成 */
    export function onEnd(obj: any);
  }
