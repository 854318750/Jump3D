...
interface _NativeAd {
   ...
   */
  reportAdShow: (object: any) => void;
  /**
   * 上报广告点击，一个广告只有一次上报有效，adId 为 load 方法获取的广告数据的 adId 字段
   */
  reportAdClick: (object: any) => void;
  /**
   * 设置广告加载成功回调
   */
...
declare namespace qg {
  ...
  export function reportMonitor(sceneName:string,type:number);
  export function navigateToMiniGame(obj: any);

  export function hasShortcutInstalled(obj: any): void;

  export function installShortcut(obj: any): void;
